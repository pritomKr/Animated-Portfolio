...
const Header = ({scrollPosition}) => {
  ...
  const handleDownload = () => {
    const resumePath = '/PritomKarmokerResume.pdf';
  ...
  return (
    <>
      <div className={`header ${bgLight ? 'bglight' : 'bgdark'}`}>
        <div className="links">
          {
            [
        ...
        <div className="button">
          <button className='resume_btn' onClick={handleDownload}>My resume</button>
        </div>
      </div>
    </>
  )
