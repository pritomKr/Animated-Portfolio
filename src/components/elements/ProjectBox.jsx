                ...
                <div className="box">
                  ...
                  <div className="bottom_box">
                    <div className="bottom_header">
                      <div className="name">Paint.app</div>
                      <div className="line">
                        <div className="l"></div>
                      </div>
                      <div className="link">
                      ...
                      <div className="tech_stack">
                        {
                          ...
                          array.map((item,i)=>(
                            i === array.length-1 ? (<span>{item}</span>) : (<span>{item} - </span>)
                          ))
                        }
                      </div>
                      <div className="content">
                        {
                          content.split(" ").length > 30 ? (
                            <>
                              {
                                // Slice the array to only include the first 30 words
                                content.split(" ").slice(0, 30).map((item, i) => (
                            ...
                            // If the number of words is less than or equal to 30
